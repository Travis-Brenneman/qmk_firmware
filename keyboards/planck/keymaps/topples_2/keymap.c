 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |CT/CPS| WIN  | ALT  | LEAD |LOWER |    SPACE    |RAISE | LEFT | DOWN |  UP  |RIGHT |
 * `-----------------------------------------------------------------------------------'
 */
  [_BASE] = LAYOUT_planck_grid(
    KC_TAB,             KC_QUOTE,           KC_COMMA,           KC_DOT,             KC_P,               KC_Y,               KC_F,               KC_G,               KC_C,               KC_R,               KC_L,               KC_BSPACE,
	KC_ESCAPE,          KC_A,               KC_O,               KC_E,               KC_U,               KC_I,               KC_D,               KC_H,               KC_T,               KC_N,               KC_S,               KC_ENTER,
	KC_LSPO,            KC_SCOLON,          KC_Q,               KC_J,               KC_K,               KC_X,               KC_B,               KC_M,               KC_W,               KC_V,               KC_Z,               KC_RSPC,
	LCTL_T(KC_CAPSLOCK),KC_LGUI,            KC_LALT,            KC_LEAD,            LOWER,              KC_SPACE,           KC_NO,              RAISE,              KC_LEFT,            KC_DOWN,            KC_UP,              KC_RIGHT
	),
 ...
 */
  ...
  [_LOWER] = LAYOUT_planck_grid(
    KC_TAB,             KC_PERC,            KC_AT,              KC_KP_MINUS,        KC_KP_SLASH,        KC_BSLASH,         KC_UNDS,             KC_KP_7,            KC_KP_8,            KC_KP_9,            KC_EQUAL,           KC_BSPACE,
	KC_ESCAPE,          KC_EXLM,            KC_QUES,            KC_KP_PLUS,         KC_KP_ASTERISK,     KC_LBRACKET,       KC_RBRACKET,         KC_KP_4,            KC_KP_5,            KC_KP_6,            KC_KP_0,            KC_KP_ENTER,
	KC_LSPO,            KC_DLR,             KC_HASH,            KC_AMPR,            KC_CIRC,            KC_LCBR,           KC_RCBR,             KC_KP_1,            KC_KP_2,            KC_KP_3,            KC_KP_DOT,          KC_RSPC,
	LCTL_T(KC_CAPSLOCK),KC_LGUI,            KC_LALT,            KC_TRANSPARENT,     KC_TRANSPARENT,     KC_SPACE,          KC_NO,               KC_TRANSPARENT,     KC_LEFT,            KC_DOWN,            KC_UP,              KC_RIGHT
),

/* RAISE
 * ,-----------------------------------------------------------------------------------.
 * | TAB  | VOL+ | HOME |  UP  |  END | PGUP | MWUP |LCLICK| MUP  |RCLICK|MCLICK| BKSP |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ESC  | VOL- | LEFT | DOWN |RIGHT | PGDN | MWDN |MLEFT |MDOWN |MLEFT | MB4  |ENTER |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | SH/( | UNDO | CUT  | COPY |PASTE | FIND | F11  | ACC0 | ACC1 | ACC2 | MB5  | SH/) |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |CT/CPS| WIN  | ALT  | LEAD |LOWER |    SPACE    |RAISE | LEFT | DOWN |  UP  |RIGHT |
 * `-----------------------------------------------------------------------------------'
 */
  ...
  [_RAISE] = LAYOUT_planck_grid(
    KC_TAB,             KC_AUDIO_VOL_UP,    LCTL(KC_PGUP),      KC_UP,              LCTL(KC_PGDOWN),    KC_PGUP,           KC_MS_WH_UP,         KC_MS_BTN1,         KC_MS_UP,           KC_MS_BTN2,         KC_MS_BTN3,         KC_BSPACE,
	KC_ESCAPE,          KC_AUDIO_VOL_DOWN,  KC_LEFT,            KC_DOWN,            KC_RIGHT,           KC_PGDOWN,         KC_MS_WH_DOWN,       KC_MS_LEFT,         KC_MS_DOWN,         KC_MS_RIGHT,        KC_MS_BTN4,         KC_ENTER,
	KC_LSPO,            KC_PC_UNDO,         KC_PC_CUT,          KC_PC_COPY,         KC_PC_PASTE,        KC_FIND,           KC_F11,              KC_MS_ACCEL0,       KC_MS_ACCEL1,       KC_MS_ACCEL2,       KC_MS_BTN5,         KC_RSPC,
	LCTL_T(KC_CAPSLOCK),KC_LGUI,            KC_LALT,            KC_TRANSPARENT,     KC_TRANSPARENT,     KC_SPACE,          KC_NO,               KC_TRANSPARENT,     KC_LEFT,            KC_DOWN,            KC_UP,              KC_RIGHT
),

/* ADJUST
 * ,-----------------------------------------------------------------------------------.
 * | RESET| F12  | F11  | F10  |  F9  |      |      | F15  | F18  | F21  | F24  | BKSP |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ESC  |  F8  |  F7  |  F6  |  F5  |      |      | F14  | F17  | F20  | F23  |ENTER |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | SH/( |  F4  |  F3  |  F2  |  F1  |      |      | F13  | F16  | F19  | F22  | SH/) |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |CT/CPS| WIN  | ALT  | LEAD |LOWER |    SPACE    |RAISE | LEFT | DOWN |  UP  |RIGHT |
 * `-----------------------------------------------------------------------------------'
 */
  [_ADJUST] = LAYOUT_planck_grid(
    RESET,              KC_F12,             KC_F11,             KC_F10,             KC_F9,              KC_TRANSPARENT,    KC_TRANSPARENT,      KC_F15,             KC_F18,             KC_F21,             KC_F24,             KC_BSPACE,
	KC_ESCAPE,          KC_F8,              KC_F7,              KC_F6,              KC_F5,              KC_TRANSPARENT,    KC_TRANSPARENT,      KC_F14,             KC_F17,             KC_F20,             KC_F23,             KC_ENTER,
	KC_LSPO,            KC_F4,              KC_F3,              KC_F2,              KC_F1,              KC_TRANSPARENT,    KC_TRANSPARENT,      KC_F13,             KC_F16,             KC_F19,             KC_F22,             KC_RSPC,
	LCTL_T(KC_CAPSLOCK),KC_LGUI,            KC_LALT,            KC_TRANSPARENT,     KC_TRANSPARENT,     KC_SPACE,          KC_NO,               KC_TRANSPARENT,     KC_LEFT,            KC_DOWN,            KC_UP,              KC_RIGHT),
...
void matrix_scan_user(void) {
	LEADER_DICTIONARY() {
		...
		SEQ_ONE_KEY(KC_T) {
			SEND_STRING("singlekeytest");
		}
		SEQ_TWO_KEYS(KC_T, KC_E) {
			SEND_STRING("twokeytest");
		}
		SEQ_THREE_KEYS(KC_T, KC_E, KC_S) {
			SEND_STRING("threekeystest");
		}
		SEQ_FOUR_KEYS(KC_T, KC_E, KC_S, KC_T) {
			SEND_STRING("fourkeystest");
		}
		SEQ_FIVE_KEYS(KC_T, KC_E, KC_S, KC_T, KC_S){
			SEND_STRING("fivekeystest");
		}
	}
